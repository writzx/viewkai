...
use viewkai_core::{PageSize, PdfPageRotation, PointsPos, inverse_rotate_point};
...
fn inverse_rotate_point_none_is_identity() {
    ...
    assert_eq!(
        inverse_rotate_point(point, PdfPageRotation::None, page_size()),
        point
    );
}
