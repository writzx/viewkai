...
pub(crate) fn demo_harness() -> Harness<'static, DemoApp> {
...
pub(crate) fn demo_harness_with_hello() -> Harness<'static, DemoApp> {
...
pub(crate) fn demo_harness_with_500page() -> Harness<'static, DemoApp> {
    let mut h = demo_harness();
